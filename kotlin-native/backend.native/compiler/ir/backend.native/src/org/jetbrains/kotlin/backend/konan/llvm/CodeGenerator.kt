...
internal class FunctionGenerationContext(val function: LLVMValueRef,
    ...
    internal fun epilogue() {
         ...
         * places with inconsistent stack layout. So for simplicity we move this calls to separate block.
         */
        val enterFrameBb = basicBlockInFunction("enter_frame", startLocation)
        LLVMMoveBasicBlockAfter(enterFrameBb, stackLocalsInitBb)
        appendingTo(enterFrameBb) {
